...
def predict_transform(prediction, inp_dim, anchors, num_classes, CUDA = False):
    ...
    print ("stride = {}, grid size = {}, attrs = {}, n_anchors ={}, anchors = {}".format(stride, grid_size, bbox_attrs, num_anchors, anchors))
    prediction = prediction.view(batch_size, bbox_attrs*num_anchors, grid_size*grid_size)
    prediction = prediction.transpose(1,2).contiguous()
    prediction = prediction.view(batch_size, grid_size*grid_size*num_anchors, bbox_attrs)
    print("Prediction size1 = {}".format(prediction.size()))
    ...
    print ("Resized prediction size = {}".format(prediction.size()))
    return prediction
